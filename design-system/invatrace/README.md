...
- **UI + body:** Inter (bundled locally, `--font-sans`). Weights 400 / 500 / 600 / 700.
...
- Container caps: 520 px for form and report-status flows, full-bleed for map + capture.
...
Every page has an override file that specialises this guide:
...
| `/reports/:reportId` | `pages/report.md` | Automated validation status |
